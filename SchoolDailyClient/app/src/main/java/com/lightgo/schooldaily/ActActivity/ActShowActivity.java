            ...
            if (msg.what == 1) {
                ...
                try {
                    ...
                    for (int k = 0; k < aCount; k++) {
                        ActivityId[k] = array.getJSONObject(k).getString("activityId");
                        ActivityTitle[k] = array.getJSONObject(k).getString("activityTitle");
                        ActivityTime[k] = array.getJSONObject(k).getString("activityTime");
                        ActivityInfo[k] = array.getJSONObject(k).getString("activityContent");
                        Initiator[k] = array.getJSONObject(k).getString("activityCreater");
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
